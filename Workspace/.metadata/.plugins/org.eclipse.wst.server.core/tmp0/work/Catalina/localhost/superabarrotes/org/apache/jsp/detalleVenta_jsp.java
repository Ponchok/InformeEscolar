 ...
 * Generated at: 2018-08-09 02:47:37 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>Detalle Venta</title>\n");
      out.write("\n");
      out.write("<!-- Bootstrap -->\n");
      ...
      out.write("\n");
      out.write("tbody {\n");
      out.write("\theight: 300px; /*   Just for the demo          */\n");
      ...
      out.write("\tfunction obtenerCantidad() {\n");
      out.write("\t\tvar contadoresMarcados = document.getElementsByName(\"cantidad\");\n");
      out.write("\t\tvar cantidades = \"\";\n");
      out.write("\t\tfor (i = 0; i < contadoresMarcados.length; i++) {\n");
      out.write("\n");
      out.write("\t\t\tcantidades += contadoresMarcados[i].value + \",\";\n");
      out.write("\t\t}\n");
      out.write("\t\tdocument.getElementById(\"cantidadesLista\").value = cantidades;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\tfunction confirmar(form) {\n");
      out.write("\t\t\n");
      out.write("\t\tif(confirm(\"Estas seguro de tu seleccion\")){\n");
      ...
      out.write("\t\t\t\t\t\t\t<li role=\"presentation\"><a href=\"soporte.html\">Soporte</a></li>\n");
      out.write("\t\t\t\t\t\t\t<li role=\"presentation\"><a href=\"informacion.html\">Información</a></li>\t\n");
      ...
      out.write("\t\t<p style=\"font-size: large; font-weight: bold;\">Por favor confirma\n");
      out.write("\t\t\ttu seleccion y la cantidad</p>\n");
      out.write("\t\t<form action=\"/superabarrotes/VentasController\" method=\"post\" name=\"confirmaVenta\">\n");
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td id=\"precio\">$");
      out.print(rs.getInt("Precio"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t<td><input type=\"number\"  min=\"1\" max=\"99\" onchange=\"obtenerCantidad()\"  name=\"cantidad\"></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t</table>\n");
      out.write("\t\t\t<button id=\"regresar\" class=\"btn btn-primary btn-lg\">\n");
      out.write("\t\t\t\t<a href=\"http://localhost:8080/superabarrotes/ventas.jsp\">Regresar</a>\n");
      out.write("\t\t\t</button>\n");
      out.write("\t\t\t<input type=\"hidden\" id=\"seleccionLista\" name=\"seleccionLista\" value=\"");
      out.print(request.getParameter("seleccionLista"));
      out.write("\"></input> \n");
      out.write("\t\t\t<input type=\"hidden\" id=\"cantidadesLista\" name=\"cantidadesLista\" value=\"\"></input>\n");
      out.write("\t\t\t<button type=\"button\" id=\"Seleccion\" class=\"btn btn-primary btn-lg\" onclick=\"confirmar(this.form)\">Continuar</button>\n");
      out.write("\t\t</form>\n");
      out.write("\t</div>\n");
      out.write("\t<!-- Ejemplo de muestra de Tabla articulos -->\n");
      out.write("\n");
