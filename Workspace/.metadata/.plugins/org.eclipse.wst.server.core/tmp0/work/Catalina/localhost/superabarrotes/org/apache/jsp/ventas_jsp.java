 ...
 * Generated at: 2018-07-15 03:59:01 UTC
...
return;
    ...
    try {
      ...
      out.write("    var data = [];\n");
      out.write("    var target = e.srcElement || e.target;\n");
      out.write("    while (target && target.nodeName !== \"TR\") {\n");
      out.write("        target = target.parentNode;\n");
      out.write("    }\n");
      out.write("    if (target) {\n");
      out.write("        var cells = target.getElementsByTagName(\"td\");\n");
      out.write("        for (var i = 0; i < cells.length; i++) {\n");
      out.write("            data.push(cells[i].innerHTML);\n");
      out.write("        }\n");
      out.write("    }\n");
